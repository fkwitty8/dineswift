...
#     average_order_time = models.DecimalField(max_digits=8, decimal_places=2, default=0.00)
...
class GroupMember(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)
    member_role = models.CharField(max_length=20, choices=MEMBER_ROLE_CHOICES, default='member')
...
class ChatSession(models.Model):
    ...
    assigned_staff = models.ForeignKey(User, on_delete=models.SET_NULL, blank=True, null=True, related_name='assigned_sessions')
    ...
    customer_satisfaction_rating = models.DecimalField(max_digits=3, decimal_places=2, blank=True, null=True)
    created_at = models.DateTimeField(auto_now_add=True)
...
class ChatMessage(models.Model):
    ...
    recipient_entity_type = models.CharField(max_length=20, choices=RECIPIENT_ENTITY_TYPE_CHOICES)
...
class CustomerLoyalty(models.Model):
    ...
    loyalty_id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    customer_user = models.ForeignKey(User, on_delete=models.CASCADE)
    restaurant = models.ForeignKey(Restaurant, on_delete=models.CASCADE)
...
class LoyaltyReward(models.Model):
    ...
    min_tier_required = models.CharField(max_length=20, choices=TIER_CHOICES, default='bronze')
    is_active = models.BooleanField(default=True)
...
class RewardRedemption(models.Model):
    ...
    points_used = models.IntegerField(validators=[MinValueValidator(0)])
    discount_amount = models.DecimalField(max_digits=10, decimal_places=2, validators=[MinValueValidator(0)])
    redemption_status = models.CharField(max_length=20, choices=STATUS_CHOICES, default='pending')
