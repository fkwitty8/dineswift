...
from apps.menu_cache.services.legacy_services import legacy_menu_service
from apps.menu_cache.models import MenuCache
from .serializers import MenuCacheV1Serializer, MenuItemSerializer, MenuCategorySerializer
...
def get_current_menu(request):
    ...
    try:
        ...
        menu_data = legacy_menu_service.get_cached_menu(restaurant_id)
...
def sync_menu(request):
    ...
    try:
        ...
        success = legacy_menu_service.sync_menu_from_supabase(restaurant_id)
...
def get_menu_version(request):
    ...
    try:
        ...
        version_info = legacy_menu_service.get_menu_version(restaurant_id)
...
class MenuCacheV1ViewSet(ViewSet):
    ...
    def list(self, request):
        ...
        try:
            ...
            serializer = MenuCacheV1Serializer(menu_cache)
    ...
    def invalidate(self, request):
        ...
        try:
            restaurant_id = request.user.restaurant_id
            legacy_menu_service.invalidate_cache(restaurant_id)
